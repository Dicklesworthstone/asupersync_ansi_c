 ...
 */
ASX_API ASX_MUST_USE asx_status asx_report_doctor_text(
    const asx_doctor_report *report, asx_report_buf *out);

/* Render a doctor report as JSON. */
ASX_API ASX_MUST_USE asx_status asx_report_doctor_json(
    const asx_doctor_report *report, asx_report_buf *out);
 ...
 */
ASX_API ASX_MUST_USE asx_status asx_report_evidence_text(
    const asx_evidence_sink *sink, asx_report_buf *out);

/* Render an evidence sink as JSON. */
ASX_API ASX_MUST_USE asx_status asx_report_evidence_json(
    const asx_evidence_sink *sink, asx_report_buf *out);
...
ASX_API ASX_MUST_USE asx_status asx_report_inspection_text(
...
ASX_API void asx_log_emit(
    asx_log_level level, const char *source, const char *message);
...
ASX_API ASX_MUST_USE asx_status asx_report_failure_artifact(
