...
#define ASX_WASM_ABI_VERSION \
    (((uint32_t)ASX_WASM_ABI_VERSION_MAJOR << 24) | \
     ((uint32_t)ASX_WASM_ABI_VERSION_MINOR << 16) | \
...
ASX_API asx_status asx_abi_check_compat(
...
ASX_API asx_status asx_boot_transition_check(
...
ASX_API asx_status asx_provider_transition_check(
...
ASX_API asx_status asx_hook_transition_check(
