...
ASX_API void asx_auth_key_from_bytes(
...
ASX_API void asx_auth_key_derive(
...
ASX_API ASX_MUST_USE int asx_auth_key_equals(
    const asx_auth_key *a, const asx_auth_key *b);
...
ASX_API void asx_auth_tag_compute(
    asx_auth_tag       *tag,
...
ASX_API ASX_MUST_USE int asx_auth_tag_verify(
...
ASX_API ASX_MUST_USE int asx_auth_tag_equals(
    const asx_auth_tag *a, const asx_auth_tag *b);
...
ASX_API ASX_MUST_USE asx_status asx_security_context_verify(
    asx_security_context *ctx,
    const uint8_t        *data,
    size_t                data_len,
    const asx_auth_tag   *tag,
...
ASX_API void asx_security_context_derive(
...
ASX_API void asx_authenticated_symbol_sign(
 ...
 * Caller must ensure data lifetime exceeds the symbol's. */
ASX_API void asx_authenticated_symbol_from_parts(
    asx_authenticated_symbol *sym,
    const uint8_t            *data,
    size_t                    data_len,
    const asx_auth_tag       *tag);
...
ASX_API ASX_MUST_USE asx_status asx_authenticated_symbol_verify(
    asx_authenticated_symbol *sym,
    asx_security_context     *ctx);

/* Returns nonzero if the symbol has been verified. */
ASX_API ASX_MUST_USE int asx_authenticated_symbol_is_verified(
