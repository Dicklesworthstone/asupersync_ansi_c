...
typedef asx_read_result (*asx_poll_read_fn)(void *adapter_state,
                                             asx_buf_mut *dst,
...
typedef asx_write_result (*asx_poll_write_fn)(void *adapter_state,
                                               const asx_buf *src,
                                               const asx_waker *waker,
...
typedef asx_write_result (*asx_poll_flush_fn)(void *adapter_state,
                                               const asx_waker *waker);

/* poll_shutdown: gracefully shut down the write side. */
typedef asx_write_result (*asx_poll_shutdown_fn)(void *adapter_state,
                                                  const asx_waker *waker);
