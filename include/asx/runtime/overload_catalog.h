...
ASX_API asx_status asx_overload_catalog_to_policy(asx_profile_id id, asx_overload_policy *out);
...
ASX_API void asx_overload_catalog_validate(asx_catalog_validation_result *result);

/* Validate a single entry for structural consistency. */
ASX_API int asx_overload_catalog_entry_valid(const asx_overload_catalog_entry *entry);
