...
typedef enum {
    ...
    ASX_PROFILE_ID_BROWSER = 8,
    ASX_PROFILE_ID_COUNT = 9
} asx_profile_id;
...
ASX_API asx_status asx_profile_get_descriptor(asx_profile_id id, asx_profile_descriptor *desc);
...
ASX_API int asx_profile_digest_compare(uint64_t digest_a, asx_profile_id profile_a,
                                       uint64_t digest_b, asx_profile_id profile_b,
...
ASX_API int asx_profile_check_parity(uint64_t expected_digest, asx_parity_result *out);
