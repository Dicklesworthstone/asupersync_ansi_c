...
ASX_API ASX_MUST_USE asx_status asx_actor_cast(asx_actor_handle actor, uint64_t msg);
...
ASX_API ASX_MUST_USE asx_status asx_actor_call(asx_actor_handle actor, uint64_t request,
...
ASX_API ASX_MUST_USE asx_status asx_call_token_poll(asx_call_token token, uint64_t *reply);
