...
uint32_t asx_work_pool_completed(const asx_work_pool *pool) { return pool->completed_count; }

uint32_t asx_work_pool_failed(const asx_work_pool *pool) { return pool->failed_count; }

uint32_t asx_work_pool_count(const asx_work_pool *pool) { return pool->count; }
...
size_t asx_parallel_map_completed(const asx_parallel_map_state *state) { return state->completed; }
...
uint32_t asx_scatter_gather_gathered(const asx_scatter_gather *sg) { return sg->gathered; }
...
uint32_t asx_spork_pipeline_stage_count(const asx_spork_pipeline *pipe) { return pipe->stage_count; }
