...
asx_socket_addr asx_socket_addr_ipv4(
...
static uint32_t next_gen(uint32_t g) { g++; return g == 0 ? 1 : g; }
...
asx_status asx_tcp_listener_bind(
...
asx_status asx_tcp_listener_poll_accept(
...
asx_status asx_tcp_listener_local_addr(
...
asx_status asx_tcp_stream_poll_read(
...
asx_status asx_tcp_stream_poll_write(
...
asx_status asx_tcp_stream_peer_addr(
