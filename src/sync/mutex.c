...
asx_status asx_mutex_close(asx_mutex_handle handle)
{
    return asx_semaphore_close(handle.sem);
}
...
asx_status asx_mutex_lock_begin(
    asx_mutex_handle handle,
...
asx_status asx_mutex_poll_lock(
...
asx_status asx_mutex_unlock(asx_mutex_guard guard)
{
    return asx_semaphore_release(guard.permit);
}
