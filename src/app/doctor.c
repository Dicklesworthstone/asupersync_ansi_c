...
static void check_runtime_initialized(
    const asx_runtime *rt, asx_doctor_report *r)
{
    if (asx_runtime_is_initialized(rt)) {
        add_check(r, "runtime", ASX_DOCTOR_OK,
                  "runtime initialized", 1, 1);
    } else {
        add_check(r, "runtime", ASX_DOCTOR_FAIL,
                  "runtime not initialized", 0, 1);
    }
}

static void check_region_utilization(
    const asx_runtime *rt, asx_doctor_report *r)
{
...
static void check_task_utilization(
    const asx_runtime *rt, asx_doctor_report *r)
{
...
static void check_obligation_utilization(
    const asx_runtime *rt, asx_doctor_report *r)
{
...
static void check_safety_profile(
    const asx_runtime *rt, asx_doctor_report *r)
{
...
static void check_containment_policy(
    const asx_runtime *rt, asx_doctor_report *r)
{
...
asx_status asx_doctor_run(
    const asx_runtime *rt, asx_doctor_report *report)
{
