...
28 subsystems, 2,011 tests in 161 test files, 9 deployment profiles.
...
2,011 tests across 161 files: unit, invariant, E2E, vignette,
conformance, fuzz, and formal verification.
