...
| Overload SLOs and user acceptance | `bd-v12u.14`, `bd-v12u.15` | Performance/admission thresholds must be resource-plane only. `bd-v12u.14` owns `parallel-bench-gate` SLO summaries with p50/p95/p99/p99.9, admission rejection, queue pressure, steal-cost proxy, and R1/R2/R3 footprint evidence; `bd-v12u.15` owns `wave-c-acceptance-demo`, the final replay/profile/incident/benchmark demo packaging gate with fail-closed unsupported-live messaging. |
