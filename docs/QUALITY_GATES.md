...
| `GATE-NATIVE-ADAPTER-COMMIT` | `parallel-parity`, `profile-parity`, `test-win32-hooks-build`, native-adapter parity/e2e targets added by child beads | `bd-v12u.2`, `bd-v12u.3`, `bd-v12u.4` | Prove POSIX/Win32 live hooks preserve deterministic commit authority or fail closed. `bd-v12u.2` adds commit-authority telemetry/gate fields; `bd-v12u.3` keeps Win32 socket/IOCP and blocking hooks fail-closed while cross-building QPC/entropy hook installation; `.4` must turn POSIX live readiness records on only with zero drift. |
