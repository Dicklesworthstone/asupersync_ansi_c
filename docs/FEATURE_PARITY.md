...
> **Last updated:** 2026-05-08 by SilverFrog — trace event schema versioning
...
| `U-INCIDENT-REPLAY-EVIDENCE` | Operator incident bundle, trace schema, and minimized replay packet | `docs/TRACE_EVENT_SCHEMA.md`; `schemas/trace_event.schema.json`; `fixtures/trace_events/*`; trace/replay/lab docs; `docs/QUALITY_GATES.md` `GATE-INCIDENT-REPLAY-BUNDLE` | `test_trace` schema compatibility tests; `lint-schema-validation`; e2e bundle emission; golden trace examples; minimizer self-tests | evidence artifacts mutating runtime state, unversioned schema drift, required/digest-visible trace-field drift, minimized failures changing class | `trace-schema-versioned` | `bd-v12u.7`, `bd-v12u.8`, `bd-v12u.13` |
